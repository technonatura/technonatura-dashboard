...
import SettingsAppInfo from "./settings/appInfo";
...
export default function RolesPage({ app }: { app: IoTAppInterface }) {
  ...
  return (
    <>
      <TabContext value={tab}>
        ...
        <TabPanel value="apps">
          {/* @ts-ignore */}
          <IoTCloudAppSensors sharedWithMe={false} />
        </TabPanel>
        <TabPanel value="settings">
          ...
          {/* @ts-ignore */}
          <DangerZone name={app.name} teammate={app.team} />
        </TabPanel>
      </TabContext>
    </>
  );
